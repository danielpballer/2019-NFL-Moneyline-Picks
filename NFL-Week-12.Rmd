...
c_data = read_csv("NFL Week 12 MA206.csv") # Update
```
...
wk11_wins = 11 #number of wins in week 11 #update this
...
indi = indiv_disp %>% 
  ...
  as.data.frame()
na = rep(indi$name, 12)
we1 = c(indi$Week_1,indi$Week_2,indi$Week_3,indi$Week_4, indi$Week_5, indi$Week_6, indi$Week_7, indi$Week_8, indi$Week_9,indi$Week_10,indi$Week_11, indi$Percent)
...
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           (wk10_combined_wins/wk10_n),(wk11_combined_wins/wk11_n), t_weekly_win_percentage), 4)
