...
c_data = read_csv("NFL Week 16 MA206.csv") # Update
```
...
wk15_wins = 11 #number of wins in week 15 #update this
...
# who actually won
winners = c("Houston Texans","New England Patriots","San Francisco 49ers","Miami Dolphins","New York Jets","New York Giants","Indianapolis Colts","Baltimore Ravens","Atlanta Falcons","New Orleans Saints","Oakland Raiders","Denver Broncos","Arizona Cardinals","Philadelphia Eagles","Kansas City Chiefs","Green Bay Packers")

CBSsports = c("Tampa Bay Buccaneers","Buffalo Bills","San Francisco 49ers","Cincinnati Bengals","Pittsburgh Steelers","New York Giants","Indianapolis Colts","Baltimore Ravens","Atlanta Falcons","New Orleans Saints","Los Angeles Chargers","Denver Broncos","Seattle Seahawks","Philadelphia Eagles","Kansas City Chiefs","Green Bay Packers")
...
```{r combined, eval=FALSE, include=FALSE}
...
```{r combined plot, eval=FALSE, include=FALSE}
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           t_weekly_win_percentage), 4) #Update
...
```{r matched week 2, eval=FALSE, include=FALSE}
...
#`r paste("Matched cadet instructor win percentage this week is", matched_win, sep = " ") `#Move this down for next week
```
