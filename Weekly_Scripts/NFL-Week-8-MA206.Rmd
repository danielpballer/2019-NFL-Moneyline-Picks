...
week_7 = read_csv("../CSV_Data_Files/NFL Week 7 MA206.csv") # Update
data = read_csv("../CSV_Data_Files/NFL Week 8 MA206.csv") # Update
```
...
indiv_disp = indiv %>%
  select(name,hour, Week_8, Percent) %>%
  full_join(season) %>%
  ...
  select(name,hour, Week_1, Week_2, Week_3, Week_4, Week_5, Week_6, Week_7, Week_8, 
