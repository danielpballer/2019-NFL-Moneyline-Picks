...
data = read_csv("../CSV_Data_Files/NFL Week 11 MA206.csv") # Update
```
...
# who actually won
winners = c("Cleveland Browns","Atlanta Falcons", "Dallas Cowboys","Indianapolis Colts","Buffalo Bills","Baltimore Ravens","Minnesota Vikings","New York Jets","New Orleans Saints","San Francisco 49ers","Oakland Raiders","New England Patriots","Los Angeles Rams","Kansas City Chiefs")

CBSsports = c("Pittsburgh Steelers","Carolina Panthers", "Dallas Cowboys","Jacksonville Jaguars","Buffalo Bills","Baltimore Ravens","Minnesota Vikings","New York Jets","New Orleans Saints","San Francisco 49ers","Oakland Raiders","Philadelphia Eagles","Los Angeles Rams","Kansas City Chiefs")
