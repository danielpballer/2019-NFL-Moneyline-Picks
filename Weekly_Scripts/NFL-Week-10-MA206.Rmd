...
data = read_csv("../CSV_Data_Files/NFL Week 10 MA206.csv") # Update
```
...
# who actually won
winners = c("Oakland Raiders","Baltimore Ravens","Cleveland Browns","Chicago Bears","New York Jets","Tennessee Titans","Tampa Bay Buccaneers","Atlanta Falcons","Miami Dolphins","Pittsburgh Steelers","Green Bay Packers","Minnesota Vikings","Seattle Seahawks")
...
indiv_disp = indiv %>%
  select(name, hour, Week_10, Percent) %>%
  full_join(season) %>%
  ...
  select(name, hour, Week_1, Week_2, Week_3, Week_4, Week_5, Week_6, Week_7, Week_8, Week_9, Week_10, 
