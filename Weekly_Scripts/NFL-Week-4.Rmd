...
data = read_csv("../CSV_Data_Files/NFL Week 4.csv")
...
wk3_wins = 12 #number of wins in week 3 #update this
...
indiv_disp = indiv %>%
  ...
  select(name, Week_1, Week_2, Week_3, Week_4, Percent, Weeks_Picked, Season_Percent) %>%
...
c_games = cadet_wk4 %>% janitor::clean_names() %>%
  select(starts_with("game"))  #Creating the set of just games
