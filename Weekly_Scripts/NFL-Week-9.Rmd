...
data = read_csv("../CSV_Data_Files/NFL Week 9.csv") # Update
...
cadet_wk9 = read_csv("../CSV_Data_Files/NFL Week 9 MA206.csv") # Update
```
...
indiv_disp = indiv %>%
  ...
  select(name, Week_1, Week_2, Week_3, Week_4, Week_5, Week_6, Week_7, Week_8, Week_9, 
...
c_games = cadet_wk9%>% janitor::clean_names() %>%
  select(starts_with("game"))  #Creating the set of just games
...
tot_pickers = dim(data)[1] + dim(cadet_wk9)[1]
```
...
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           (wk7_combined_wins/wk7_n), (wk8_combined_wins/wk8_n), t_weekly_win_percentage), 4)
