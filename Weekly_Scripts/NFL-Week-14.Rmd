...
week_11 = read_csv("../CSV_Data_Files/NFL Week 11.csv") 
week_12 = read_csv("../CSV_Data_Files/NFL Week 12.csv") 
week_13 = read_csv("../CSV_Data_Files/NFL Week 13.csv") # Update
data = read_csv("../CSV_Data_Files/NFL Week 14.csv") # Update
...
c_data = read_csv("../CSV_Data_Files/NFL Week 14 MA206.csv") # Update
```
...
season_games = group_games+g1_n+g2_n+g3_n+g4_n+g5_n+g6_n+g7_n+g8_n+g9_n+g10_n+g11_n+g12_n+wk13_n
season_wins  = wk1_wins+wk2_wins+wk3_wins+wk4_wins+wk5_wins+wk6_wins+wk7_wins+wk8_wins+wk9_wins+
  wk10_wins+wk11_wins+wk12_wins+wk13_wins+correct_count$n[which(correct_count$Correct == "Yes")]
...
wins = round(c((wk1_wins/g1_n),(wk2_wins/g2_n),(wk3_wins/g3_n), (wk4_wins/g4_n), (wk5_wins/g5_n),
               ...
               (wk10_wins/g10_n),(wk11_wins/g11_n),(wk12_wins/g12_n),(wk13_wins/g13_n),  weekly_win_percentage),4)
...
indi = indiv_disp %>% 
  ...
  as.data.frame()
na = rep(indi$name, 14)
we1 = c(indi$Week_1,indi$Week_2,indi$Week_3,indi$Week_4, indi$Week_5, indi$Week_6, indi$Week_7, indi$Week_8, indi$Week_9,indi$Week_10,indi$Week_11,indi$Week_12,indi$Week_13, indi$Percent)
...
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           (wk13_combined_wins/wk13_n),t_weekly_win_percentage), 4)
