...
cadet_wk13 = read_csv("NFL Week 13 MA206.csv") # Update
cadet_wk14 = read_csv("NFL Week 14 MA206.csv") # Update
c_data = read_csv("NFL Week 15 MA206.csv") # Update
```
...
wk14_wins = 10 #number of wins in week 14 #update this
...
# who actually won
winners = c("Baltimore Ravens","Atlanta Falcons","Tampa Bay Buccaneers","New York Jets","San Francisco 49ers","Minnesota Vikings","Denver Broncos","Baltimore Ravens","Cleveland Browns","Green Bay Packers","Los Angeles Chargers","Pittsburgh Steelers","Tennessee Titans","Kansas City Chiefs","Los Angeles Rams","Philadelphia Eagles")
...
current_indiv = formattable(indiv_disp,
            align =c("l","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c"), 
            list(
              `Indicator Name` = formatter("span", 
                                style = ~ style(color = "grey",font.weight = "bold")),
...
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           (wk13_combined_wins/wk13_n),(wk14_combined_wins/wk14_n),t_weekly_win_percentage), 4) #Update
