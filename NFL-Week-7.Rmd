...
cadet_wk7 = read_csv("NFL Week 7 MA206.csv") # Update
```
...
indiv = data %>%
  select(`Name`, `Game 1`,`Game 2`, `Game 3`, `Game 4`, `Game 5`, `Game 6`, `Game 7`, `Game 8`, `Game 9`, `Game 10`, `Game 11`, `Game 12`, `Game 13`, `Game 14`) %>%  janitor::clean_names()
...
indiv_disp = indiv %>%
  ...
  select(name, Week_1, Week_2, Week_3, Week_4, Week_5, Week_6, Week_7, 
...
c_games = cadet_wk7 %>% janitor::clean_names() %>%
  select(starts_with("game"))  #Creating the set of just games
...
tot_pickers = dim(data)[1] + dim(cadet_wk7)[1]
