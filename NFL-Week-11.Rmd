...
data = read_csv("NFL Week 11.csv") # Update
...
c_data = read_csv("NFL Week 11 MA206.csv") # Update
```
...
wk_max = c(wk1_n, wk2_n, wk3_n, wk4_n, wk5_n, wk6_n, wk7_n, wk8_n, wk9_n, wk10_n, n)
...
# who actually won
winners = c("Cleveland Browns","Carolina Panthers", "Dallas Cowboys","Jacksonville Jaguars","Buffalo Bills","Kansas City Chiefs","Carolina Panthers","Buffalo Bills","Seattle Seahawks","Oakland Raiders","Los Angeles Chargers","Denver Broncos","Baltimore Ravens","Dallas Cowboys") 
...
wins = round(c((wk1_wins/g1_n),(wk2_wins/g2_n),(wk3_wins/g3_n), (wk4_wins/g4_n), (wk5_wins/g5_n),
               ...
               (wk10_wins/g10_n), weekly_win_percentage),4)
