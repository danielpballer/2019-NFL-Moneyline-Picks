...
wk10_wins = 5 #number of wins in week 10 #update this
...
wk10_winners = c("Oakland Raiders","Baltimore Ravens","Cleveland Browns","Chicago Bears","New York Jets","Tennessee Titans","Tampa Bay Buccaneers","Atlanta Falcons","Miami Dolphins","Pittsburgh Steelers","Green Bay Packers","Minnesota Vikings","Seattle Seahawks") # Update this 
...
season = indiv_weekly_pred(week_1, wk1_winners) %>%
  ...
  full_join(indiv_weekly_pred(data, winners) %>% ####### Add line for previous week and update to current week
      rename("Week_11" = Week)) %>%
  mutate(Percent = round(Week_11/n,4)) %>%
  arrange(-Percent)

#determining how many weeks each person picked, season correct percentage, and adjusted season percentage.
indiv_disp = season %>%
