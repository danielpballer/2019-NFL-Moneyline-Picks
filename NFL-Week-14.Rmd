...
c_data = read_csv("NFL Week 13 MA206.csv") # Update
```
...
wk13_wins = 8 #number of wins in week 13 #update this
...
c_wins = round(c((wk1_combined_wins/wk1_n), (wk2_combined_wins/wk2_n),(wk3_combined_wins/wk3_n),
           ...
           (wk13_combined_wins/wk13_n),t_weekly_win_percentage), 4) #Update
